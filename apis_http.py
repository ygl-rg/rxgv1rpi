...
class ZbModuleAdm(Base):
    def initialize(self, **kwargs):
        self.FUNC_TBL = {"ListModule": functools.partial(ZbModule.List, self),
                         'ProbeDevice': functools.partial(ZbModule.ProbeDevice, self),
                         'ResetModule': functools.partial(ZbModule.Reset, self),
                         'BackupModule': functools.partial(ZbModule.Backup, self),
                         'RestoreModule': functools.partial(ZbModule.Restore, self),
                         'RebootModule': functools.partial(ZbModule.Reboot, self),
                         'RebootAll': functools.partial(ZbModule.RebootAll, self)}
